import { Stroke } from "src/app/lib/styles"

const fasIcon = (iconName: string, style?: any) => (
    `<i class="fas fa-${iconName}" style=${style} />`
);
...
const Icon: any = {
    ...
    solid: `<i class="far fa-circle" />`,

    transparent: `<i class="far fa-circle" />`,
    halfFilled: `<div style="height: 0.7em; marginRight: 1em; position: relative">
                    <i class="fas fa-circle" style="left: 50%; opacity: 0.3; position: absolute; top: 0"/>
                    <i class="far fa-circle" style="left: 50%; position: absolute; top: 0"/>
                </div>`,
